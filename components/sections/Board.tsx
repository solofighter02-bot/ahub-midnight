...
export function Board() {
  return (
    <section id="board" className="relative isolate overflow-hidden bg-[linear-gradient(180deg,#FFF7F2_0%,#FFF8F3_100%)] py-16 md:py-24">
      {/* Background Elements */}
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        ...
        <SectionHeading
          eyebrow="LEADERSHIP"
          title="Visionary Leaders Guiding Our Mission"
          subtitle="Distinguished board members bringing decades of experience, strategic insight, and commitment to building India's thriving startup ecosystem."
          align="center"
        />
